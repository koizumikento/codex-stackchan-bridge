...
class FirmwareContractTests(unittest.TestCase):
    ...
    def test_runtime_touch_and_power_publishers_use_real_k151_adapters(self) -> None:
        ...
        self.assertIn("si12t_read_output_register", main)
        self.assertIn("SI12T_OUTPUT1_ADDR", main)
        self.assertIn("stackchan_touch_output_read_ok", main)
        self.assertIn("stackchan_touch_output_raw", main)
        self.assertIn("touch_output_read_failures", main)
        self.assertIn("telemetry.zone_mask == 0 && stackchan_touch_output_read_ok", main)
    ...
    def test_audio_policy_uses_baseline_chunk_contract(self) -> None:
        ...
        self.assertIn("uint32 total_chunks", audio_msg)
        self.assertIn("uint32 total_bytes", audio_msg)
        self.assertIn("bool end_of_stream", audio_msg)
        self.assertIn("uint8[<=1280] pcm", audio_msg)
        adpcm = (ROOT / "include" / "stackchan" / "adpcm.hpp").read_text()
        self.assertIn("ImaAdpcmDecoderState", adpcm)
        self.assertIn("decode_ima_adpcm_4bit_payload", adpcm)
        self.assertIn("kImaAdpcmHeaderBytes = 4", adpcm)
    ...
    def test_audio_capture_chunk_timeout_returns_structured_result(self) -> None:
        ...
        self.assertIn("kAudioPlaybackLoadBufferBytes = 32 * 1024", main)
        ...
        self.assertIn('"/stackchan/%s/device/audio/playback/acks"', main)
        ...
        self.assertIn("#include <stackchan_msgs/msg/audio_playback_ack.h>", main)
        self.assertIn("stackchan_msgs__msg__AudioPlaybackAck audio_playback_ack_ros_message", main)
        self.assertIn("rcl_publisher_t audio_playback_ack_ros_publisher", main)
        ...
        self.assertIn("ROSIDL_GET_MSG_TYPE_SUPPORT(stackchan_msgs, msg, AudioPlaybackAck)", main)
        ...
        self.assertIn("audio_playback_chunk_request.has_acknowledgement", main)
        self.assertIn("audio_playback_chunk_request.acknowledged_sequence", main)
        self.assertIn("audio_playback_chunk_request.has_missing_sequence = waiting_for_gap", main)
        self.assertIn("audio_playback_chunk_request.free_buffer_chunks", main)
        self.assertIn("publish_play_audio_ack_window(waiting_for_gap)", main)
        self.assertIn("publish_play_audio_ack_window(true)", main)
        self.assertIn("audio_playback_ack_ros_message.free_buffer_chunks", main)
        self.assertIn("handle_audio_playback_chunk_response", main)
        self.assertIn("handle_audio_playback_load_service", main)
        self.assertIn("is_loaded_audio_topic_chunk", main)
        self.assertIn("handle_loaded_audio_topic_chunk", main)
        self.assertIn('"loaded audio topic chunk accepted"', main)
        ...
        self.assertIn("playback_prepare_mic_busy", main)
        self.assertIn("microphone capture did not stop before playback", main)
        self.assertNotIn("while (M5.Mic.isRecording()", main)
        ...
        self.assertIn("queue_loaded_play_audio_buffer", main)
        self.assertIn('"loaded_playback_queued"', main)
        self.assertIn("play_audio_loaded_direct_playback_ms", main)
        ...
        self.assertIn("play_audio_loaded_adpcm_state", main)
        self.assertIn("stackchan_msgs__msg__AudioChunk__IMA_ADPCM_4BIT", main)
        self.assertIn("play_audio_loaded_encoded_bytes", main)
        self.assertIn("play_audio_loaded_decoded_play_bytes", main)
        self.assertIn("play_audio_loaded_play_adpcm_state", main)
        self.assertIn("play_audio_loaded_pull_loading", main)
        self.assertIn("start_loaded_play_audio_playback", main)
        self.assertIn("accept_loaded_audio_pull_chunk", main)
        self.assertIn('"ima_adpcm_4bit"', main)
        self.assertIn('"loaded_pull_started"', main)
        self.assertIn('"loaded_pull_empty"', main)
        self.assertIn('"loaded_pull_incomplete"', main)
        self.assertIn('log_play_audio_load_diagnostic(\n        "pull"', main)
        self.assertIn("decode_ima_adpcm_nibble", main)
        self.assertIn("play_audio_loaded_session_stale", main)
        ...
        self.assertIn("audio_load_result_detail", main)
        self.assertIn('\\"expected_seq\\"', main)
        self.assertIn('\\"received_seq\\"', main)
        self.assertIn('\\"detail\\"', main)
        self.assertIn('\\"rx_ms\\"', main)
        self.assertIn('\\"gap_ms\\"', main)
        ...
        self.assertIn("sequence % kAudioPlaybackChunkDiagnosticSampleInterval == 0", main)
        ...
        self.assertIn("kAudioPlaybackTerminalStaleSuppressMs", main)
        self.assertIn("remember_play_audio_terminal_stale_suppression", main)
        self.assertIn("recent_terminal_play_audio_command", main)
        self.assertIn("clear_play_audio_terminal_stale_suppression", main)
        ...
        self.assertIn("const bool recover_mic = !result.ok && audio_capture_session_active", main)
        self.assertIn("recover_capture_mic_after_abort(\"capture_abort\")", main)
    ...
    def test_sensor_input_diagnostic_profile_is_firmware_only(self) -> None:
        ...
        self.assertIn("touch_output_read_ok", main)
        self.assertIn("touch_output_raw", main)
        self.assertIn("touch_output_read_failures", main)
    ...
    def test_firmware_camera_capture_action_is_bounded_and_redacted(self) -> None:
        ...
        self.assertIn("#include <stackchan_msgs/msg/camera_frame_chunk.h>", main)
        ...
        self.assertIn('"/stackchan/%s/device/camera/chunks"', main)
        self.assertIn("ROSIDL_GET_ACTION_TYPE_SUPPORT(stackchan_msgs, CaptureCamera)", main)
        self.assertIn("ROSIDL_GET_MSG_TYPE_SUPPORT(stackchan_msgs, msg, CameraFrameChunk)", main)
        self.assertIn("stackchan_camera_snapshot_initialized = initialize_camera_adapter()", main)
        ...
        self.assertIn("kCameraHorizontalMirror = false", main)
        ...
        self.assertIn("camera warmup frame drain failed", main)
        ...
        self.assertIn("stackchan::kCameraFrameChunkBytes", main)
        self.assertIn("camera JPEG payload exceeds 96 KiB", main)
        self.assertIn("publish_capture_camera_frame_chunks", main)
        self.assertIn("camera JPEG chunk publish failed", main)
    ...
    def test_sensor_policy_uses_explicit_bounds_and_errors(self) -> None:
        ...
        self.assertIn("kCameraFrameChunkBytes = 256", sensors)
